...
// dummy users for now, will come from backend later
const users = [
  { id: 1, name: 'Praneeth', online: true },
  { id: 2, name: 'Surya', online: false },
  { id: 3, name: 'Karthik', online: true },
  { id: 4, name: 'Elon Musk', online: false },
]
